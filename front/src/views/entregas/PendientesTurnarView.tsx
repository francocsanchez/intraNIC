      ...
      <section className="rounded-lg border border-border bg-card p-3 shadow-sm">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <h1 className="mt-0.5 text-xl font-semibold tracking-tight text-card-foreground">Unidades pendientes de turnar</h1>
          </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              {canImportPendientes ? (
                <button
                  ...
                  className="inline-flex h-9 items-center justify-center gap-2 rounded-md border border-border bg-background px-3 text-sm font-semibold text-foreground transition hover:bg-secondary disabled:cursor-not-allowed disabled:opacity-60"
                >
        ...
        {canImportPendientes ? (
          <div className="mt-3 flex items-center gap-2 border-t border-border pt-2 text-sm text-muted-foreground">
