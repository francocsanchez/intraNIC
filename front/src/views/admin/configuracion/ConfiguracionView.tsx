        ...
        <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h2 className="mt-1 text-lg font-semibold tracking-tight text-gray-900">Envío de agenda</h2>
              <p className="mt-1 text-sm text-gray-500">
                Configura por sucursal los destinatarios del PDF automático de la agenda de entrega.
              </p>
            </div>
        ...
        <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h2 className="mt-1 text-lg font-semibold tracking-tight text-gray-900">Hot Alert</h2>
              <p className="mt-1 text-sm text-gray-500">
                Configura los destinatarios del correo diario consolidado de Hot Alert de SSI Ventas.
              </p>
            </div>
