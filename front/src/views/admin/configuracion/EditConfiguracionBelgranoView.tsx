    ...
    <div className="w-full space-y-6 px-4 py-6">
      ...
      <section className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <article className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tight text-gray-900">Belgrano</p>
        </article>
      ...
      <form className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm" noValidate onSubmit={handleSubmit(handleForm)}>
        <div className="border-b border-gray-200 px-6 py-4">
          ...
          <p className="mt-1 text-sm text-gray-500">Selecciona vendedores habilitados para el disponible de Belgrano.</p>
        </div>
