    ...
    <div className="w-full space-y-6 px-4 py-6">
      ...
      <section className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm">
        <div className="border-b border-gray-200 px-6 py-4">
          <h2 className="text-base font-semibold tracking-tight text-gray-900">Listado</h2>
        </div>
              ...
              {colores.map((color) => (
                <tr key={color._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-center">
                    <span className={["inline-flex rounded-full px-3 py-1 text-xs font-semibold", color.activo ? "bg-emerald-100 text-emerald-700" : "bg-gray-100 text-gray-600"].join(" ")}>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex justify-center gap-2">
                      ...
                      <button
                        type="button"
                        onClick={() => deleteMutation.mutate(color._id)}
