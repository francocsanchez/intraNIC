    ...
    <div className="w-full px-4 py-10">
      <div className="mx-auto max-w-5xl space-y-6">
        <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <h1 className="mt-1 text-2xl font-semibold tracking-tight text-gray-900">Página no encontrada</h1>
          <p className="mt-2 text-sm text-gray-500">La ruta que intentaste abrir no existe o ya no está disponible.</p>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="border-b border-gray-200 p-8 lg:border-b-0 lg:border-r">
              <div className="inline-flex items-center gap-3 rounded-full border border-gray-200 bg-gray-50 px-4 py-2">
                ...
                <span className="text-xs font-semibold uppercase tracking-[0.18em] text-gray-600">Error 404</span>
              </div>
              ...
              <div className="mt-6 flex items-start gap-4">
                ...
                <div>
                  <p className="text-6xl font-semibold tracking-tight text-gray-900">404</p>
                  <h2 className="mt-2 text-xl font-semibold tracking-tight text-gray-900">No pudimos encontrar esta página</h2>
            ...
            <div className="p-8">
              <div className="rounded-2xl border border-gray-200 bg-gray-50 p-5">
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-gray-500">Sugerencias</p>

                <div className="mt-4 space-y-3">
                  <div className="rounded-xl border border-gray-200 bg-white px-4 py-3">
                    <p className="text-sm font-medium text-gray-900">Revisá la URL</p>
                    <p className="mt-1 text-xs text-gray-500">Verificá que la dirección esté escrita correctamente.</p>
                  </div>

                  <div className="rounded-xl border border-gray-200 bg-white px-4 py-3">
                    <p className="text-sm font-medium text-gray-900">Volvé al menú principal</p>
                    <p className="mt-1 text-xs text-gray-500">Desde allí podés navegar otra vez a la sección correcta.</p>
                  </div>

                  <div className="rounded-xl border border-gray-200 bg-white px-4 py-3">
                    <p className="text-sm font-medium text-gray-900">Intentá nuevamente más tarde</p>
                    <p className="mt-1 text-xs text-gray-500">Algunas vistas pueden estar en desarrollo o todavía no estar habilitadas.</p>
                  </div>
                </div>
              </div>
