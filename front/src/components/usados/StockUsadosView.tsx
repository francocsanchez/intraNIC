  ...
  return (
    <div className="font-preset w-full space-y-3 px-2 py-3">
      <section className="overflow-hidden rounded-lg border border-border bg-card text-card-foreground shadow-sm">
        ...
        <div className="grid border-t border-border xl:grid-cols-[2.6fr_0.9fr]">
        ...
        <article className="flex min-h-28 flex-col items-center justify-center border-t border-border px-3 py-3 text-center xl:border-t-0 xl:border-l">
            <p className="text-4xl font-semibold tracking-tight text-foreground">{resumen?.total ?? items.length}</p>
            <p className="mt-1 text-sm text-muted-foreground">Totales</p>
        </article>
        </div>
      </section>
          ...
          <table className="min-w-full text-sm">
            <thead className="border-b border-gray-200 bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-[0.18em] text-gray-500">Ano</th>
              ...
              >
                <Dialog.Panel className="w-full max-w-xl overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-xl">
                  <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4">
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-gray-500">{subtitle}</p>
                  ...
                  <div className="px-6 py-5">
                    <div className="rounded-2xl border border-gray-200 bg-gray-50 px-4 py-4">
                      <p className="text-sm font-medium text-gray-900">{itemSeleccionado?.observaciones || "Sin observaciones"}</p>
                    </div>
                  </div>
