export const paths = {
  ...
  convencional: {
    ...
    rendicionesGastos: "/comercial/rendiciones-gastos",
    rendicionesGastosNueva: "/comercial/rendiciones-gastos/nueva",
    rendicionesGastosDetalleRoute: "/comercial/rendiciones-gastos/:id",
    rendicionesGastosDetalle: (id: string) => `/comercial/rendiciones-gastos/${id}`,
