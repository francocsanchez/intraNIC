...
- Las solicitudes de cambio de color con chasis asignado no pueden crearse; las existentes se alertan en tabla. Solo `stock`, `gerente` y `superAdmin` pueden rechazarlas, dejando el rechazo como estado final auditado.
